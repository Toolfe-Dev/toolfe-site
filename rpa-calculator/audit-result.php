                        ...
                        <div class="input-main-row">
                            ...
                            <div class="stats">
                              ...
                              <ul class="stats">
                                ...
                                <li><p class="">Your estimated development cost is <span class="text-grad text-bold fw-bold "><span><?php echo currency_sym($Currency); ?></span> <?php echo number_format($dev_cost, 2)  ?></span>, and maintenance cost is <span class="text-grad text-bold fw-bold "><span><?php echo currency_sym($Currency); ?></span> <?php echo number_format($main_cost, 2)  ?></span> which may vary. </p></li>
                              ...
                              <div class="contact-infos-inner ">
                                  <ul class="contact-social-links mb-5">
                                      <li>
                                        ...
                                        <h5 class="mt-3 mb-5">Transform <span class="text-grad"><?php echo $companyName ?></span> Savings with Automation!</h5>
                                      </li>
                                      <li>
                                        <img src="../assets/imgs/contact_us/tick.svg" alt="tick" />
                                        <h5 class="mt-3 mb-5">See <span class="text-grad"><?php echo $companyName ?></span> True Investment Value</h5>
                                      </li>
                                      <li>
                                        <img src="../assets/imgs/contact_us/tick.svg" alt="tick" />
                                        <h5 class="mt-3 mb-5">Maximize Budget Efficiency for <span class="text-grad"><?php echo $companyName ?></span></h5>
                                      </li>
                                  </ul>
                              </div>
                          </div>
