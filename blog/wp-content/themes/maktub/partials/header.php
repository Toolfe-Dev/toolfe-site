...
<?php if( epcl_get_option('enable_search_header') == '1' || empty($epcl_theme) ): ?>
    ...
    <div class="hide-on-mobile hide-on-tablet hide-on-desktop">
        <div id="search-lightbox" class="mfp-hide grid-container grid-small grid-parent">
            <h4 class="title textcenter hide-on-mobile hide-on-tablet"><?php printf( esc_html__('Press %s to close', 'maktub'), '<span>ESC</span>' ); ?></h4>
            <div class="search-wrapper section">                
                <?php get_search_form(); ?>
            </div>            
            <div class="categories">
                <h5 class="textcenter"><?php echo esc_html__('Or check our Popular Categories...', 'maktub'); ?></h5>
                <div class="widget_tag_cloud">
                    <div class="tagcloud">
                        <?php
                            wp_tag_cloud( array(
                                'number'   => 6, // displays at most 45 tags
                                'orderby'  => 'count', // order tags alphabetically
                                'order'    => 'DESC', // order tags by ascending order
                                'taxonomy' => 'category' // you can even make tags for custom taxonomies
                            ) );
                        ?>
                    </div>
                </div>
