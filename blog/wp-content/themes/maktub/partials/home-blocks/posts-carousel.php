...
<?php if( !empty($carousel) ): ?>
    <div class="grid-container grid-ularge np-mobile np-tablet">
        <!-- start: .carousel -->
        <section class="epcl-carousel slick-slider outer-arrows epcl-mode-<?php echo esc_attr($epcl_mode); ?> slides-<?php echo intval( $epcl_module['posts_carousel_show_limit'] ); ?>" data-show="<?php echo intval( $epcl_module['posts_carousel_show_limit'] ); ?>" data-rtl="<?php echo is_rtl(); ?>" id="<?php echo wp_unique_id('epcl-post-carousel-'); ?>">
            <?php foreach($carousel as $post): setup_postdata($post); ?>
                ...
                <div class="item <?php if($image_url) echo 'image-bg'; ?>">
                    <article>
                        ...
                        <div class="info">
                            <?php if( $epcl_module['posts_carousel_enable_date'] == true ): ?>
                                <div class="meta">
                            ...
                            <div class="clear"></div>
                            <?php if( $epcl_module['posts_carousel_enable_author'] == true ): ?>
                                <div class="meta">
