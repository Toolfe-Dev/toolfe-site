...
<div id='wpforms-builder-mobile-notice' class='wpforms-fullscreen-notice'>
	...
	<img src="<?php echo esc_url( WPFORMS_PLUGIN_URL . 'assets/images/sullie-builder-mobile.webp' ); ?>" class='sullie-icon' alt="<?php esc_attr_e( 'Sullie the WPForms mascot', 'wpforms-lite' ); ?>">
