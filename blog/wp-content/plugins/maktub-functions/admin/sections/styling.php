...
CSF::createSection( $opt_name, array(
	...
	'fields' => array(
		...
		array(
            ...
            'desc' =>  esc_html__('Decorations and main effect.', 'epcl_framework'),
			// 'validate' => 'color',
            'transparent' => false,
            'class' => 'epcl-hide-transparent',
            'validate' => 'csf_validate_hex_color_transparent',
...
CSF::createSection( $opt_name, array(
	...
	'fields' => array(
        ...
        array(
			...
			'default' => $white,
            'subtitle' =>  esc_html__("Default: ".$white, 'epcl_framework'),
            'desc' => esc_html__('All main containers uses a white background to generate contrast (Single post, Text Sliders, Posts lists, etc).', 'epcl_framework'),
			// 'validate' => 'color',
			'transparent' => false
        ),   
        // array(
...
CSF::createSection( $opt_name, array(
	...
	'fields' => array(
        ...
        array(
            ...
            'subtitle' => esc_html__('Default: 1240px', 'epcl_framework'),
        ...
        array(
            ...
            'desc' => __('Some modules uses larger width, example: <b>Grid Posts (Masonry)</b>'),
            'default    ' => '1400px',
            'placeholder' => '1400px',
            'attributes'  => array(
                'style' => 'width: 100px',
...
CSF::createSection( $opt_name, array(
	...
	'fields' => array(
        ...
        array(
			...
			'default' => $black,
            'subtitle' => esc_html__("Default: $black, Text: $white", 'epcl_framework'),
            'transparent' => false,
        ...
        array(
			...
			'subtitle' => esc_html__("Default: $text_color, Hover: $primary_color", 'epcl_framework'),
			// 'validate' => 'color',
			'active' => false,
			'default' => array(
				'color' => $text_color,
