...
CSF::createSection( $opt_name, array(
	...
	'fields' => array(
        ...
        array(
			...
			'type' => 'switcher',
			'title' => esc_html__('Footer Theme Author Link', 'epcl_framework'),
			// 'desc' => __('This link will not be indexed and will help us to bring more features to our themes.Of course, you can disable it, if you want.', 'epcl_framework'),
			'default' => '1'
        ),
        array(
