...
if ( ! class_exists( 'epcl_related_articles' ) ) {
	class epcl_related_articles extends WP_Widget{
		...
		function __construct(){
			$widget_ops = array('description' => esc_html_x('Display related articles from the current post.', 'admin', 'maktub') );
			parent::__construct( false, esc_html_x('(EP) Related Articles', 'admin', 'maktub'), $widget_ops);
		}
