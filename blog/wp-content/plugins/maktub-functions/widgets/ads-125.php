...
if ( ! class_exists( 'epcl_ads_125' ) ) {
	...
	class epcl_ads_125 extends WP_Widget{
		...
		function __construct(){
			$widget_ops = array('description' => esc_html_x('Display 125x125 grid ads.', 'admin', 'maktub'));
			parent::__construct( false, esc_html_x('(EP) 125x125 Ads', 'admin', 'maktub'), $widget_ops);
		}
		...
		function form($instance){
			...
			<p><small><?php echo esc_html_x('Copy and paste your ads code:', 'admin', 'maktub'); ?></small></p>
			<p>
				<label for="<?php echo $this->get_field_id('ads_1'); ?>"><?php echo esc_html_x('Ads Block n&ordm; 1:', 'admin', 'maktub') ?> </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('ads_2'); ?>"><?php echo esc_html_x('Ads Block n&ordm; 2:', 'admin', 'maktub') ?> </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('ads_3'); ?>"><?php echo esc_html_x('Ads Block n&ordm; 3:', 'admin', 'maktub') ?> </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('ads_4'); ?>"><?php echo esc_html_x('Ads Block n&ordm; 4:', 'admin', 'maktub') ?> </label>
