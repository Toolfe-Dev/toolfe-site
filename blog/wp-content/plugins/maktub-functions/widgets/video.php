...
if ( ! class_exists( 'EPCL_video' ) ) {
	class EPCL_video extends WP_Widget{
		...
		function __construct(){
			$widget_ops = array('description' => esc_html_x('Display a Youtube or Vimeo video.', 'admin', 'maktub'));
			parent::__construct( false, esc_html_x('(EP) Video', 'admin', 'maktub'), $widget_ops);
		}
		...
		function form($instance){
			...
			<p>
				<label for="<?php echo $this->get_field_id('type'); ?>"><?php echo esc_html_x('Type:', 'admin', 'maktub') ?> </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('url'); ?>"><?php echo esc_html_x( 'URL:', 'admin', 'maktub'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('height'); ?>"><?php echo esc_html_x( 'Height:', 'admin', 'maktub'); ?></label>
