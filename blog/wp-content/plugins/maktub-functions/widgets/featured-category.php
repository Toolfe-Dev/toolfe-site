...
if ( ! class_exists( 'epcl_featured_category' ) ) {
	class epcl_featured_category extends WP_Widget{
		...
		function __construct(){
			$widget_ops = array( 'description' => esc_html_x('Display posts from a certain category.', 'admin', 'maktub') );
			parent::__construct( false, esc_html_x('(EP) Posts by Category', 'admin', 'maktub'), $widget_ops);
		}
		...
		function form($instance){
			...
			<p>
				<label for="<?php echo $this->get_field_id('category'); ?>"><?php echo esc_html_x('Category:', 'admin', 'maktub') ?> </label>
