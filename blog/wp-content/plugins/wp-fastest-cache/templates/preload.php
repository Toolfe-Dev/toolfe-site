		...
		<div class="window-content-wrapper" style="padding: 15px;">
			...
			<div class="window-content" style="z-index: 1000; height: auto; position: relative; display: inline-block; width: 100%;">
				...
				<div class="wiz-input-cont" style="width: 94% !important;margin-bottom: 15px !important;">
					...
					<a style="margin-left:5px;" target="_blank" href="http://www.wpfastestcache.com/features/restart-preload-after-completed/"><img src="<?php echo plugins_url("wp-fastest-cache/images/info.webp"); ?>"></a>
				</div>
