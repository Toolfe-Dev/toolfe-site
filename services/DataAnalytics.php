            ...
            <div class="about2-inner-box">
                ...
                <div class="section-header d-flex align-items-center justify-content-between">
                    <div class="left">
                        ...
                        <p class="whatwe-do">Harnessing advanced analytics, we convert raw data into actionable insights, unlocking your business's potential.  Our robust framework ensures efficient transformation, driving growth and maximizing efficiency through the power of data</p>
                    </div>
                </div>
            ...
            <div class="portfolio-lists d-flex w-full gap-24">
                <div class="portfolio-col">
                    ...
                    <div class="portfolio-card portfolio-card-1 card-h">
                        <div class="portfolio-img">
                            <img src="../assets/imgs/services/datanalyticsbento/1.webp" alt="1" />
                        </div>
                    ...
                    <div class="portfolio-card portfolio-card-2 card-h">
                        ...
                        <div class="portfolio-img">
                            <img src="../assets/imgs/services/datanalyticsbento/2.webp" alt="2" />
                        </div>
                    </div>
                ...
                <div class="portfolio-col">
                    ...
                    <div class="portfolio-card portfolio-card-2 card-h">
                        ...
                        <div class="portfolio-img">
                            <img src="../assets/imgs/services/datanalyticsbento/3.webp" alt="3" />
                        </div>
                    </div>
                    <div class="portfolio-card portfolio-card-1 card-h">
                        <div class="portfolio-img portfolio-img-card-style2">
                            <img src="../assets/imgs/services/datanalyticsbento/4.webp" alt="4" />
                        </div>
                        <div class="portfolio-body">
                            <h2>Risk <br>
                                Assessment</a></h2>
                ...
                <div class="portfolio-col">
                    ...
                    <div class="portfolio-card portfolio-card-1 card-h">
                        <div class="portfolio-img">
                            <img src="../assets/imgs/services/datanalyticsbento/5.webp" alt="5" />
                        </div>
                        <div class="portfolio-body">
                            <h2>Sentiment <br>
                             Analysis</a></h2>
...
Informs decisions through sentiment and feedback analysis.</p>
                    ...
                    <div class="portfolio-card portfolio-card-2 card-h">
                        ...
                        <div class="portfolio-img portfolio-img-card-style3">
                            <img src="../assets/imgs/services/datanalyticsbento/6.webp" alt="6" />
                        </div>
                    </div>
    ...
    <section class="partner-area">
        <div class="custom-container">
            <div class="custom-row align-items-center">
                ...
                <div class="right">
                    <div class="img-box">
                        <img src="../assets/imgs/services/techstack/data_analytics.webp" alt="data_analytics" />
                    </div>
                </div>
            </div>
        </div>
