      ...
      T ||
        (T = (function () {
          ...
          if (s()) {
            ...
            if (s.includes("Version/index.php")) {
              const [e, a] = s
                .split("Version/index.php")[1]
                .split(" ")[0]
                .split(".")
                .map((e) => Number(e));
              t = e < 16 || (16 === e && a < 2);
    ...
    function (e) {
      ...
      const l = (e) =>
        ...
        o = (e) => {
          const t = r();
          let s;
          s = e ? new URL(e.php) : t.location;
          const a = s.pathname
              .slice(1)
              .split("https://wpriverthemes.com/")
              .filter((e) => "" !== e),
            i = a.length;
        ...
        d = (e, s) => {
          ...
          let n;
          n = t.params.url ? new URL(t.params.php) : a.location;
          const o = t.slides[s];
