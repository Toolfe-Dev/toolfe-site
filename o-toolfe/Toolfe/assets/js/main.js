...
if (job_apply) {
  // Application Modal 1
  var modal_application = document.querySelector("#application_form2");
  var apply_trigger = document.querySelector("#apply_close");
  var back_form1 = document.querySelector("#back_form1");

  job_apply.addEventListener("click", function () {
  ...
  // Application Modal 2
  var modal_application_2 = document.querySelector("#application_form");
  ...
  tHero.from(".hero2-shape-toolfe img", {
    xPercent: -100,
    duration: 1,
  }, '-=6.5')
  ...
  word_come_long.forEach((word_come_long) => {
   ...
   // RTL Demo Menu Item
   var nav = document.querySelector('.toolfe_services a');
   nav.addEventListener("click", (e) => {
     e.preventDefault();
     const ids = nav.getAttribute("href")
     gsap.to(window, { duration: 0.5, scrollTo: ids, ease: "power4.out" });
   ...
   var rtl_demo_btn = document.querySelector('.rtl_demo_btn');
   rtl_demo_btn.addEventListener("click", (e) => {
     e.preventDefault();
     const ids = rtl_demo_btn.getAttribute("href")
     gsap.to(window, { duration: 0.5, scrollTo: ids, ease: "power4.out" });
   })
  ...
  if (slider_9_image) {
    ...
    for (let col = 0; col < cols; col++) {
      ...
      el.href = "http://127.0.0.1:5500/contact/"
    ...
    function go(dir) {
      if (!playing) {
        ...
        for (let p in parts) {
          ...
          next.href = "http://127.0.0.1:5500/contact/"
