      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Contact us Responses</h4>
            ...
            <!-- Responsive Table -->
            <div class="card">
              <h5 class="card-header">Contact us Responses</h5>
                ...
                <table class="table" id="sortable">
                  <thead>
                    ...
                    <tr class="text-nowrap">
                      ...
                      <th onclick="sortBy(7)">Subject</th>
                      <th onclick="sortBy(8)">Message</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                        $num = 1;
                        $query=mysqli_query($conn, "select * from toolfe_contact");
