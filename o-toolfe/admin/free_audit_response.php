      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Free Audit Responses</h4>
            ...
            <!-- Responsive Table -->
            <div class="card">
              <h5 class="card-header">Free Audit Responses</h5>
                ...
                <table class="table" id="sortable">
                  <thead>
                    ...
                    <tr class="text-nowrap">
                      ...
                      <th onclick="sortBy(4)">Company</th>
                      <th onclick="sortBy(5)">Email</th>
                      <th onclick="sortBy(6)">Phone</th>
                      <th onclick="sortBy(7)">Address</th>
                      <th onclick="sortBy(8)">City</th>
                      <th onclick="sortBy(7)">Category</th>
                      <th onclick="sortBy(8)">Size</th>
                      <th onclick="sortBy(9)">Challenges</th>
                      <th onclick="sortBy(10)">Other Info's</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                        $num = 1;
                        $query=mysqli_query($conn, "select * from toolfe_free_audit_form");
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['gma_company_name']; ?></td>
                      <td><?php echo $row['gma_email']; ?></td>
                      <td><?php echo $row['gma_phone']; ?></td>
                      <td><?php echo $row['gma_address']; ?></td>
                      <td><?php echo $row['gma_city']; ?></td>
                      <td><?php echo $row['gma_category']; ?></td>
                      <td><?php echo $row['gma_size']; ?></td>
                      <td><?php echo $row['gma_challenges']; ?></td>
                      <td><?php echo $row['gma_other_info']; ?></td>
                    </tr>
                    <?php
                        }
                    ?>
