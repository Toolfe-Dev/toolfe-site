...
<head>
  ...
  <title>Toolfe | Callback Responses</title>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Callback Responses</h4>

            <!-- Responsive Table -->
            <div class="card">
              <h5 class="card-header">Callback Responses</h5>
              ...
              <div class="table-responsive text-nowrap">
                <table class="table" id="sortable">
                  ...
                  <tbody>
                    <?php
                        $num = 1;
                        $query=mysqli_query($conn, "select * from toolfe_callback");
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['callback_name']; ?></td>
                      <td><?php echo $row['callback_email']; ?></td>
                      <td><?php echo $row['callback_phone']; ?></td>
                    </tr>
                    <?php
                        }
                    ?>
