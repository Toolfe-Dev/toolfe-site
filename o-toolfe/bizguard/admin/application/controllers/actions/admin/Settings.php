...
class Settings extends MY_Controller {
    ...
    /**
     * Envato Settings Page Input Handling.
     *
     * @return  void
     * @version 2.0
     */
    ...
    {
        $data = [
            'envato_ask_purchase_code_ticket' => only_binary( post( 'envato_ask_purchase_code_ticket' ) ),
            'envato_se_create_ticket' => only_binary( post( 'envato_se_create_ticket' ) ),
            'envato_ask_purchase_code_chat' => only_binary( post( 'envato_ask_purchase_code_chat' ) ),
            'envato_se_create_chat' => only_binary( post( 'envato_se_create_chat' ) ),
            'envato_how_to_find_pc' => do_secure( post( 'envato_how_to_find_pc' ) ),
            'envato_support_policy_url' => do_secure( post( 'envato_support_policy_url' ) )
        ];
    ...
    /**
     * Modules Settings Page Input Handling.
     *
     * @return  void
     * @version 2.0
     */
    ...
    {
        $data = [
            'module_tickets' => only_binary( post( 'module_tickets' ) ),
            'module_knowledgebase' => only_binary( post( 'module_knowledgebase' ) ),
            'module_faqs' => only_binary( post( 'module_faqs' ) ),
            'module_announcements' => only_binary( post( 'module_announcements' ) )
        ];
    ...
    public function general()
    {
        if ( $this->form_validation->run( 'settings_general' ) )
        {
            $data = [
                ...
                'site_custom_css' => do_secure( post( 'site_custom_css' ) ),
    ...
    public function support()
    {
        $data = [
            ...
            'sp_allow_ticket_feedback_delete' => only_binary( post( 'sp_allow_ticket_feedback_delete' ) )
        ];
    ...
    public function users()
    {
        $data = [
            ...
            'u_2f_authentication' => only_binary( post( 'u_2f_authentication' ) ),
            'u_2fa_cookie_expiry' => do_secure( post( 'u_2fa_cookie_expiry' ) ),
            'u_2fa_show_remember' => only_binary( post( 'u_2fa_show_remember' ) )
        ];
    ...
    public function apis()
    {
        $data = [
            ...
            'envato_api_token' => do_secure( post( 'envato_api_token' ) )
        ];
