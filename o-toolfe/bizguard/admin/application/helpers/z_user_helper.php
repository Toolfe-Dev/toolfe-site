...
{
    function set_2fa( $user, $remember_login = '', $social = '' )
    {
        $ci =& get_instance();
        ...
        if ( ! is_email_settings_filled() )
        {
            ...
            else r_error_gr( 'missing_email_config' );
        }
...
if ( ! function_exists( 'update_profile_settings' ) )
{
    function update_profile_settings( $user_id, $area = '' )
    {
        ...
        $data = [
            ...
            'two_factor_authentication' => only_binary( post( 'two_factor_authentication' ) ),
