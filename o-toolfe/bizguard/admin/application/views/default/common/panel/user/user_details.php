...
<div class="card">
  <div class="card-header d-flex align-items-center">
    ...
    <?php if ( $this->uri->segment( 1 ) === 'admin' && $this->uri->segment( 3 ) === 'edit_user' ) { ?>
      <div class="text-sm ml-auto">
        <button class="btn btn-sm btn-primary" data-toggle="dropdown" type="button">
  ...
  <div class="card-body">
    ...
    <?php if ( db_config( 'u_2f_authentication' ) ) { ?>
      <div class="form-group">
        <label for="two-factor-authentication" class="form-label"><?php echo lang( '2f_authentication' ); ?></label>
        <select class="form-control select2 search-disabled" id="two-factor-authentication" name="two_factor_authentication">
          <option value="1" <?php echo select_single( 1, $user->two_factor_authentication ); ?>><?php echo lang( 'enable' ); ?></option>
          <option value="0" <?php echo select_single( 0, $user->two_factor_authentication ); ?>><?php echo lang( 'disable' ); ?></option>
        </select>
      </div>
      <!-- /.form-group -->
    <?php } ?>
...
<div class="card">
  ...
  <div class="card-body">
    <div class="icheck icheck-primary d-inline-block mr-2">
      ...
      <label for="email-notifications-1"><span class="label-span"><?php echo lang( 'enable' ); ?></span></label>
    </div>
    <!-- /.icheck -->
    <div class="icheck icheck-primary d-inline-block">
      ...
      <label for="email-notifications-0"><span class="label-span"><?php echo lang( 'disable' ); ?></span></label>
    </div>
    <!-- /.icheck -->
  </div>
  <!-- /.card-body -->
