...
?>
<!DOCTYPE html>
<html lang="<?php echo lang( 'lang_iso_code' ); ?>" dir="<?php echo lang( 'theme_direction' ); ?>">
...
<!-- Theme Style: -->
<?php if ( lang( 'theme_direction' ) == 'rtl' ) { ?>
  <link rel="stylesheet" href="<?php admin_lte_asset( 'css/rtl/adminlte.min.css' ); ?>">
<?php } else { ?>
...
<?php if ( lang( 'theme_direction' ) == 'rtl' ) { ?>
  <link rel="stylesheet" href="<?php assets_path( 'css/custom.rtl.css?v=' . v_combine() ); ?>">
<?php } else { ?>
  <link rel="stylesheet" href="<?php assets_path( 'css/custom.ltr.css?v=' . v_combine() ); ?>">
<?php } ?>

<!-- jQuery: -->
<script src="<?php assets_path( 'vendor/jquery/jquery_summernote.min.js' ); ?>"></script>
...
<script>
  ...
  const limitedNotifications = '<?php echo env_url(); ?>actions/user/account/limited_notifications';
  const notificationsCount = '<?php echo env_url(); ?>actions/user/account/notifications_count';
  var isLoggedIn = '<?php echo intval( $this->zuser->is_logged_in ); ?>';
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light text-sm">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a href="<?php echo base_url(); ?>" class="btn btn-dark">
          <i class="fas fa-home mr-sm-2 nav-home-icon"></i>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a id="notifications-bell" class="nav-link border-right-1" data-toggle="dropdown" href="#" aria-expanded="false">
          ...
          <span class="badge badge-danger notifications-count"><?php echo ( $new_notifications ) ? html_escape( $new_notifications ) : ''; ?></span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right dropdown-notifications">
          <span id="notifications-empty" class="dropdown-item text-center"><?php echo lang( 'loading' ); ?></span>
          <div id="limited-notifications"></div>
        </div>
        <!-- /.dropdown-menu -->
      </li>
      <li class="nav-item dropdown">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy text-sm" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <?php if ( $this->zuser->has_permission( 'tickets' ) || $this->zuser->has_permission( 'chats' ) ) { ?>
            <li class="nav-header mt-3"><?php echo lang( 'tickets_and_chats' ); ?></li>
          <?php } ?>
                ...
                <li class="nav-item">
                  <a href="<?php echo env_url( "admin/tickets/all" ); ?>" class="nav-link <?php echo panel_activate_sub_child_page( ['all', 'ticket', 'create_ticket', 'history'], 'admin', 'tickets' ); ?>">
                    ...
                    <p><?php echo lang( 'all_tickets' ); ?></p>
								...
								<li class="nav-item">
                  <a href="<?php echo env_url( "admin/tickets/my_departments" ); ?>" class="nav-link <?php echo panel_activate_sub_child_page( 'my_departments' ); ?>">
                    <i class="fas fa-object-group nav-icon"></i>
                    <p><?php echo lang( 'my_departments' ); ?></p>
                  </a>
                </li>
                <li class="nav-item">
          ...
          <?php if ( is_others_modules_allowed() ) { ?>
            <li class="nav-header mt-3"><?php echo lang( 'others' ); ?></li>
          <?php } ?>
          ...
          <?php if ( $this->zuser->has_permission( 'settings' ) ) { ?>
            <li class="nav-item has-treeview <?php echo panel_open_parent_menu( 'settings' ); ?>">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="<?php echo env_url( 'admin/settings/modules' ); ?>" class="nav-link <?php echo panel_activate_sub_child_page( 'modules' ); ?>">
                    <i class="fas fa-boxes nav-icon"></i>
                    <p><?php echo lang( 'modules' ); ?></p>
                  </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a href="<?php echo env_url( 'admin/settings/envato' ); ?>" class="nav-link <?php echo panel_activate_sub_child_page( 'envato' ); ?>">
                    <i class="fas fa-leaf nav-icon"></i>
                    <p><?php echo lang( 'envato' ); ?></p>
                  </a>
                </li>
                <li class="nav-item">
