...
<?php if ( lang( 'theme_direction' ) == 'rtl' ) { ?>
  <link rel="stylesheet" href="<?php assets_path( 'vendor/bootstrap/css/bootstrap.rtl.min.css' ); ?>">
<?php } else { ?>
...
<?php if ( lang( 'theme_direction' ) == 'rtl' ) { ?>
  <link rel="stylesheet" href="<?php assets_path( 'css/public/style.rtl.css?v=' . v_combine() ); ?>">
<?php } else { ?>
  <link rel="stylesheet" href="<?php assets_path( 'css/public/style.ltr.css?v=' . v_combine() ); ?>">
<?php } ?>
  ...
  <div class="container-fluid">
    ...
    <div class="d-flex">
      <?php if ( $this->zuser->is_logged_in ) { ?>
        <a class="text-muted me-4 d-lg-none" href="<?php echo env_url( 'user/notifications' ); ?>">
          ...
          <span class="badge bg-danger notifications-count"><?php echo ( $new_notifications ) ? html_escape( $new_notifications ) : ''; ?></span>
        </a>
      <?php } ?>
    ...
    <div class="collapse navbar-collapse" id="navbar">
      <ul class="navbar-nav mx-auto mb-0 mt-2 mt-lg-0">
        ...
        <?php if ( db_config( 'module_faqs' ) == 1 ) { ?>
          <li class="nav-item">
            <a class="nav-link <?php echo activate_page( 'faqs' ); ?>" href="<?php echo env_url( 'faqs' ); ?>"><?php echo lang( 'faqs' ); ?></a>
          </li>
        <?php } ?>
        
        <?php if ( $this->zuser->is_logged_in && db_config( 'module_announcements' ) == 1 ) { ?>
          <li class="nav-item">
        ...
        <?php } else { ?>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end rounded border-0 shadow-lg" aria-labelledby="account-dropdown">
              ...
              <?php if ( db_config( 'module_tickets' ) == 1 ) { ?>
                <li>
