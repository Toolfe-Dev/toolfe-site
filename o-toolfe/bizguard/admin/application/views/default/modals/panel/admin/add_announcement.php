    ...
    <div class="modal-content">
      <form class="z-form" action="<?php admin_action( 'tools/add_announcement' ); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="customer" name="description" required>

          </div> 
          <div class="form-group">
            <label for="customer">Client<span class="required">*</span></label>
            <input type="text" class="form-control" id="customer" name="client" required>

          </div> 
          <!-- /.form-group -->
          <label for="announcement-add"><?php echo lang( 'announcement' ); ?> <span class="required">*</span></label>
          <textarea class="form-control textarea" id="announcement-add" name="announcement" rows="5" required></textarea>
        </div>
        <!-- /.modal-body -->
