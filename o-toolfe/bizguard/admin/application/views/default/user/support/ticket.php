    ...
    <div class="col-lg-8">
      <div class="list-wrapper shadow-sm">
        ...
        <div class="list-item d-flex">
          ...
          <!-- /.user-pic-parent -->
          <div class="px-3">
            <p class="mt-1 mb-0 fw-bold"><?php echo html_escape( $ticket->first_name . ' ' . $ticket->last_name ); ?></p>
        ...
        <?php if ( ! empty( $replies ) ) {
          foreach ( $replies as $reply ) {
            ...
            <div class="list-item d-flex" id="section-<?php echo md5( $reply->id ); ?>">
              ...
              <!-- /.user-pic-parent -->
              <div class="px-3">
                <p class="mt-1 mb-0 fw-bold"><?php echo html_escape( $reply->first_name . ' ' . $reply->last_name ); ?></p>
        ...
        <div class="card border-0 shadow-sm mt-3 z-ticket-reply">
					<form class="z-form" action="<?php user_action( 'support/share_feedback' ); ?>" method="post" data-csrf="manual">
						...
						<div class="text-center mb-3">
							...
							<label class="btn btn-outline-success btn-wide me-1" for="feedback-type-1"><?php echo lang( 'great' ); ?></label>
      ...
      <!-- /.card -->
			...
			<?php if ( $ticket->feedback_type != null ) {
				...
				<div class="card border-0 shadow-sm mt-3 z-ticket-reply">
					<p class="fw-bold mb-3 pb-2 border-bottom"><?php echo lang( 'requestor_feedback' ); ?></p>
          ...
          <?php if ( db_config( 'sp_allow_ticket_feedback_delete' ) == 1 ) { ?>
            <button class="btn btn-outline-danger mt-3" data-bs-toggle="modal" data-bs-target="#delete-ticket-feedback"><?php echo lang( 'delete' ); ?></button>
          <?php } ?>
    ...
    <div class="col-lg-4">
      <div class="detail-as-list shadow-sm mt-3 mt-lg-0 clearfix">
        <ul class="nav flex-column pb-0 mb-0">
          <li class="nav-item">
            <strong><?php echo lang( 'requester' ); ?></strong>
            <span class="float-end" data-bs-toggle="tooltip" title="<?php echo html_escape( $ticket->first_name . ' ' . $ticket->last_name ); ?>">
        ...
        <div class="text-center border-top mt-3">
          ...
          <div class="pt-3 d-inline-block">
            <a href="<?php echo env_url( 'user/support/create_ticket' ); ?>" class="btn btn-wide btn-outline-primary mt-1 ms-2"><?php echo lang( 'create_new' ); ?></a>
          </div>
        </div>
        <!-- /.border-top -->
      </div>
...
<?php load_modals( ['user/ticket_attachments', 'user/delete_ticket_feedback'] ); ?>