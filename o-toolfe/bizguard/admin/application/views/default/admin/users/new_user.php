        ...
        <div class="col-md-9">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group col-md-6"> 
                <label for="send-password"><?php echo "Subscription"; ?></label>
                <select id="send-password" class="form-control select2 search-disabled" name="plane_mon">
                  <option value="0"><?php echo "Monthly"; ?></option>
                  <option value="1"><?php echo "Yearly"; ?></option>
                </select>
              </div>
               <!-- /.form-group -->
              <div class="form-group col-md-6"> 
                <label for="send-password"><?php echo 'Select Plane' ; ?></label>
                <select id="send-password" class="form-control select2 search-disabled" name="user_plane">
                  <option value="1"><?php echo "Essential"; ?></option>
                  <option value="2"><?php echo "Pro"; ?></option>
                  <option value="3"><?php echo "Premium"; ?></option>
                  <option value="4"><?php echo "Executive"; ?></option>
                  <option value="5"><?php echo "No Plane"; ?></option>
                </select>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
