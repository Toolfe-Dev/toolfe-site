          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="icheck icheck-primary d-inline-block mr-2">
                ...
                <label for="email-verified-1"><span class="label-span"><?php echo lang( 'yes' ); ?></span></label>
              </div>
              <!-- /.icheck -->
              <div class="icheck icheck-primary d-inline-block">
                ...
                <label for="email-verified-0"><span class="label-span"><?php echo lang( 'no' ); ?></span></label>
              </div>
              <!-- /.icheck -->
            </div>
            <!-- /.card-body -->
