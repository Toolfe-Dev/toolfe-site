      ...
      <div class="col-sm-12">
        ...
        <div class="card">
          <div class="card-header d-flex align-items-center border-bottom-0">
            ...
            <div class="ml-auto">
              <form action="<?php echo env_url( 'admin/tickets/' . html_escape( $this->uri->segment( 3 ) ) ); ?>" class="d-inline-block form-inline">
                <input
                      ...
                      <tr id="record-<?php echo html_escape( $ticket->id ); ?>">
                          ...
                          <div class="d-inline-block align-top">
                            ...
                            <a class="mr-1" href="<?php echo env_url( 'admin/tickets/ticket/' . html_escape( $ticket->id ) ); ?>">
                              ...
                              <?php if ( $ticket->feedback_type !== null ) { ?>
                                <?php if ( $ticket->feedback_type == 0 ) { ?>
                                  <i class="far fa-thumbs-down text-danger small mr-1" title="<?php echo lang( 'poor_received_support' ); ?>"></i>
                                <?php } else if ( $ticket->feedback_type == 1 ) { ?>
                                  <i class="far fa-thumbs-up text-success small mr-1" title="<?php echo lang( 'great_received_support' ); ?>"></i>
                                <?php } ?>
                              <?php } ?>
                        ...
                        <td class="text-right">
                          <div class="btn-group">
                            ...
                            <?php if ( $this->zuser->has_permission( 'delete_ticket' ) ) { ?>
