      ...
      <div class="col-sm-12">
        ...
        <div class="card">
          <div class="card-header d-flex align-items-center border-bottom-0">
            ...
            <div class="ml-auto">
              <form action="<?php echo env_url( 'admin/knowledge_base/articles' ); ?>" class="d-inline-block form-inline">
                <input
                  ...
                  if ( ! empty( $articles ) )
                  {
                    foreach ( $articles as $article ) {
                      ...
                      <tr id="record-<?php echo html_escape( $id ); ?>">
                        ...
                        <td class="text-right">
                          <span class="badge badge-primary"><?php echo ( $article->logged_in_only == 1 ) ? lang( 'yes' ) : lang( 'no' ); ?></span>
                        </td>
                        <td class="text-right">
                          <?php
