          ...
          <div class="card">
            ...
            <div class="card-body">
              <select class="form-control select2 search-disabled" id="logged-in-only" name="logged_in_only">
                <option value="0" <?php echo select_single( 0, $article->logged_in_only ); ?>><?php echo lang( 'no' ); ?></option>
                <option value="1" <?php echo select_single( 1, $article->logged_in_only ); ?>><?php echo lang( 'yes' ); ?></option>
              </select>
            </div>
            <!-- /.card-body -->
          </div>
