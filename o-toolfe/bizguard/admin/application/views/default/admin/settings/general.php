            ...
            <div class="card-body">
              <div class="tab-content">
                ...
                <div class="tab-pane" id="custom-css" role="tabpanel" aria-labelledby="custom-css-tab">
                  <label for="site-custom-css"><?php echo lang( 'custom_css' ); ?></label>
                  <textarea id="site-custom-css" class="form-control" name="site_custom_css" rows="5"><?php echo html_escape( db_config( 'site_custom_css' ) ); ?></textarea>
                ...
                <div class="tab-pane" id="maintenance" role="tabpanel" aria-labelledby="maintenance-tab">
                  ...
                  <div class="icheck icheck-primary d-inline-block mr-2">
                    ...
                    <label for="maintenance-mode-1"><span class="label-span"><?php echo lang( 'enable' ); ?></span></label>
                  </div>
                  <!-- /.icheck -->
                  <div class="icheck icheck-primary d-inline-block">
                    ...
                    <label for="maintenance-mode-0"><span class="label-span"><?php echo lang( 'disable' ); ?></span></label>
                  </div>
                  <!-- /.icheck -->
                </div>
                <!-- /.tab-pane -->
                ...
                <div class="tab-pane" id="miscellaneous" role="tabpanel" aria-labelledby="miscellaneous-tab">
                  ...
                  <div class="icheck icheck-primary d-inline-block mr-2">
                    ...
                    <label for="site-show-cookie-popup-1"><span class="label-span"><?php echo lang( 'yes' ); ?></span></label>
                  </div>
                  <!-- /.icheck -->
                  <div class="icheck icheck-primary d-inline-block">
                    ...
                    <label for="site-show-cookie-popup-0"><span class="label-span"><?php echo lang( 'no' ); ?></span></label>
                  </div>
                  <!-- /.icheck -->
                </div>
                <!-- /.tab-pane -->
