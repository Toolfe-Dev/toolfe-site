(function ($) {
  ...
  $(".biz-page-wrapperz").attr(
    "class",
    "biz-page-wrapperz " + localStorage.getItem("biz-page-wrapperz-cuba")
  );
  if (localStorage.getItem("biz-page-wrapperz-cuba") === null) {
    $(".biz-page-wrapperz").addClass("compact-wrapper dark-sidebar");
  }
