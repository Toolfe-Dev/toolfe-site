(function () {
    ...
    plotOptions: {
      radialBar: {
        hollow: {
          margin: 5,
          size: "70%",
          image: "../files-front/images/dashboard-5/follower.webp",
          imageWidth: 50,
          imageHeight: 50,
          imageClipped: false,
        },
  ...
  var followerchart = new ApexCharts(
    document.querySelector("#followerchart"),
    followeroptions
  );
