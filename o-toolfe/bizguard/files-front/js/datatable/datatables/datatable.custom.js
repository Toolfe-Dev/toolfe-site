(function ($) {
  $(document).ready(function () {
    ...
    $("#advance-8").DataTable({
      language: {
        url: "../files-front/json/German.json",
      },
    });
    $("#advance-9").DataTable({
      searching: false,
    ...
    $("#data-source-2").DataTable({
      ajax: "../files-front/ajax/arrays.txt",
    });
    var dataSet = [
      [
        "Tiger Nixon",
    ...
    $("#data-source-4").DataTable({
      ...
      ajax: "../files-front/json/server-side.json",
    });
    ...
    $("#ajax-data-object").DataTable({
      ajax: "../files-front/ajax/object.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#ajax-data-nested-object").DataTable({
      processing: true,
      ajax: "../files-front/ajax/object_nested.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#orthogonal-data").DataTable({
      ajax: "../files-front/ajax/orthogonal.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#server-side-datatable").DataTable({
      processing: true,
      serverSide: true,
      ajax: "../files-front/ajax/server-processing.php",
    });
    ...
    $("#datatable-http").DataTable({
      ...
      serverSide: true,
      ajax: {
        url: "../files-front/ajax/server-processing.php",
        data: function (d) {
          d.myKey = "myValue";
        },
      },
