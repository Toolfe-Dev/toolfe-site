...
$(".biz-page-wrapperz").attr("class", "biz-page-wrapperz " + localStorage.getItem('biz-page-wrapperz'));

if (localStorage.getItem("biz-page-wrapperz") === null) {
  $(".biz-page-wrapperz").addClass("compact-wrapper");
...
if ($('#pageWrapper').hasClass('compact-wrapper')) {
  ...
  if (contentwidth < '992') {
    ...
    $('.biz-biz-page-bodyz-wrapperz').removeClass('horizontal-menu').addClass('sidebar-icon');
    jQuery('.submenu-title').append('<div class="according-menu"><i class="fa fa-angle-right"></i></div>');
    jQuery('.submenu-title').click(function () {
...
if ($(window).width() <= 991) {
  $('.sidebar-wrapper .back-btn').on('click', function (e) {
    $(".biz-page-headerz").toggleClass("close_icon");
