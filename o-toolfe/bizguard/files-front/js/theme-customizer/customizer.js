(function ($) {
  ...
  $(document).ready(function () {
    $(".customizer-color li").on("click", function () {
      ...
      $("#color").attr("href", "../files-front/css/" + color + ".css");
    ...
    $(".biz-sidebar-mainz-bg-setting li").on("click", function () {
      $(".biz-sidebar-mainz-bg-setting li").removeClass("active");
      $(this).addClass("active");
    ...
    $(".sidebar-type li").on("click", function () {
      ...
      var boxed = "";
      if ($(".biz-page-wrapperz").hasClass("box-layout")) {
        boxed = "box-layout";
      }
      switch (type) {
        case "compact-sidebar": {
          $(".biz-page-wrapperz").attr(
            "class",
            "biz-page-wrapperz compact-wrapper " + boxed
          );
          $(this).addClass("active");
          localStorage.setItem("biz-page-wrapperz-cuba", "compact-wrapper");
          break;
        }
        case "normal-sidebar": {
          $(".biz-page-wrapperz").attr(
            "class",
            "biz-page-wrapperz horizontal-wrapper " + boxed
          );
          $(".logo-wrapper")
            .find("img")
            .attr("src", "../files-front/images/logo/logo.png");
          localStorage.setItem("biz-page-wrapperz-cuba", "horizontal-wrapper");
          break;
        }
        case "default-body": {
          $(".biz-page-wrapperz").attr("class", "biz-page-wrapperz  only-body" + boxed);
          localStorage.setItem("biz-page-wrapperz-cuba", "only-body");
          break;
        }
        case "dark-sidebar": {
          $(".biz-page-wrapperz").attr(
            "class",
            "biz-page-wrapperz compact-wrapper dark-sidebar" + boxed
          );
          localStorage.setItem(
            "biz-page-wrapperz-cuba",
        ...
        case "compact-wrap": {
          $(".biz-page-wrapperz").attr(
            "class",
            "biz-page-wrapperz compact-sidebar" + boxed
          );
          localStorage.setItem("biz-page-wrapperz-cuba", "compact-sidebar");
          break;
        }
        case "color-sidebar": {
          $(".biz-page-wrapperz").attr(
            "class",
            "biz-page-wrapperz compact-wrapper color-sidebar" + boxed
          );
          localStorage.setItem(
            "biz-page-wrapperz-cuba",
        ...
        case "compact-small": {
          $(".biz-page-wrapperz").attr(
            "class",
            "biz-page-wrapperz compact-sidebar compact-small" + boxed
          );
          localStorage.setItem(
            "biz-page-wrapperz-cuba",
        ...
        case "box-layout": {
          $(".biz-page-wrapperz").attr(
            "class",
            "biz-page-wrapperz compact-wrapper box-layout " + boxed
          );
          localStorage.setItem(
            "biz-page-wrapperz-cuba",
        ...
        case "enterprice-type": {
          $(".biz-page-wrapperz").attr(
            "class",
            "biz-page-wrapperz horizontal-wrapper enterprice-type" + boxed
          );
          localStorage.setItem(
            "biz-page-wrapperz-cuba",
        ...
        case "modern-layout": {
          $(".biz-page-wrapperz").attr(
            "class",
            "biz-page-wrapperz compact-wrapper modern-type" + boxed
          );
          localStorage.setItem(
            "biz-page-wrapperz-cuba",
        ...
        case "material-layout": {
          $(".biz-page-wrapperz").attr(
            "class",
            "biz-page-wrapperz horizontal-wrapper material-type" + boxed
          );
          localStorage.setItem(
            "biz-page-wrapperz-cuba",
        ...
        case "material-icon": {
          $(".biz-page-wrapperz").attr(
            "class",
            "biz-page-wrapperz compact-sidebar compact-small material-icon" + boxed
          );
          localStorage.setItem(
            "biz-page-wrapperz-cuba",
        ...
        case "advance-type": {
          $(".biz-page-wrapperz").attr(
            "class",
            "biz-page-wrapperz horizontal-wrapper enterprice-type advance-layout" +
              boxed
          );
          localStorage.setItem(
            "biz-page-wrapperz-cuba",
