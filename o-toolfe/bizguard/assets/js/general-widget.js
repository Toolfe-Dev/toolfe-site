(function () {
  ...
  if (radialchart1) {
    ...
    let taskData = radialchart1.getAttribute('data-task');
    
    const radial1 = {
      color: ["var(--theme-deafult)"],
      dropshadowColor: "var(--theme-deafult)",
      radialYseries: [taskData],
    };
  ...
  if (radialchart2) {
    let taskData = radialchart2.getAttribute('data-task');
  ...
  if (radialchart3) {
    ...
    let taskData = radialchart3.getAttribute('data-task');
